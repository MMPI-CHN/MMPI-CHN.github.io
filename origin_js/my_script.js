...
var resultArray = [
  ...
  ["Hy（癔症）", 65, 60, "T分高于65，高分，这反映出被测可能有以下部分（程度）的表现：以各种躯体症状的方式来应对刺激或逃避责任；有头痛、胸痛、乏力或贫血的症状；躯体症状常突然出现，又突然消失；对躯体症状的原因缺乏认识；表现出慢性焦虑、紧张及抑郁；极少有幻觉", "中等分，被测也许：心理上显得特别不成熟，孩子气；特别自我中心，有自恋倾向；期待他人的关注，要求得到他人的情感；采用间接方式获取他人注意", "低于平均的抑郁水平，说明被试：通常较为积极、现实；若分数低于45，则被试可能表现出过分地现实、世故，让人感觉刻薄生硬；少数人愤世嫉俗，甚至憎恶世人，认为人生充满苦难；但该项低分往往反映出被试是现实主义者，表现出的敌意并非必要，只是应对方式过于生硬，缺乏礼貌或圆滑"],

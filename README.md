...
2. 其实这是我第一次严格意义上使用 GitHub（抄作业不算）……很多规矩还不清楚……这个项目的部分源码是用了 `AstralLing` 的，俺也不知道咋引用，把[网址](https://github.com/AstralLing/MMPI2)贴这里吧。然后就是这个哥哥的代码很好用，也很漂亮，感兴趣的可以看看[这个](https://github.com/SHENGYUKing/MMPI_Test)  
